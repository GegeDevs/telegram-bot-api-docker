...
DEFAULT_ARGS="--http-port 8081 --dir=${TELEGRAM_WORK_DIR} --temp-dir=${TELEGRAM_TEMP_DIR} --username=${USERNAME} --groupname=${GROUPNAME} --api-id=${TELEGRAM_API_ID} --api-hash=${TELEGRAM_API_HASH}"
CUSTOM_ARGS=""
